...
/*   Updated: 2018/10/05 18:01:32 by svilau           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void FragTrap::minionTrap(std::string const &target) {
  ...
  std::cout << " <" << this->_name << "> launches minions attack <" << target
            << ">, causing " << this->_minionTrapDamage << " points of damage !"
            << std::endl;
...
void FragTrap::freezingAttack(std::string const &target) {
  std::cout << " <" << this->_name << "> freezes <" << target << ">, causing "
            << this->_freezingAttackDamage << " points of damage !"
            << std::endl;
...
void FragTrap::throwingGrenade(std::string const &target) {
  ...
  std::cout << " <" << this->_name << "> throws grenade aiming <" << target
            << ">, causing " << this->_throwingGrenadeDamage
...
void FragTrap::lazerAttack(std::string const &target) {
  ...
  std::cout << " <" << this->_name << "> launches lazer aiming <" << target
            << ">, causing " << this->_lazerAttackDamage
            << " points of damage !" << std::endl;
...
void FragTrap::lavaRainAttack(std::string const &target) {
  ...
  std::cout << " <" << this->_name << "> starts lava rain <" << target
            << ">, causing " << this->_lavaRainAttackDamage
            << " points of damage !" << std::endl;
...
void FragTrap::vaulthunter_dot_exe(std::string const &target) {
  ...
  std::string attacksNamePool[totalAttacks] = {"minionTrap", "freezingAttack",
                                               "throwingGrenade", "lazerAttack",
                                               "lavaRainAttack"};
  typedef void (FragTrap::*Attacks)(std::string const &target);
  Attacks attacksPointerPool[totalAttacks] = {
      &FragTrap::minionTrap,      &FragTrap::freezingAttack,
      &FragTrap::throwingGrenade, &FragTrap::lazerAttack,
      &FragTrap::lavaRainAttack,
  };
